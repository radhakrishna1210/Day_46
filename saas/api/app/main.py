...
from app.routers import audit_log, auth, business, buyers, dashboard, decisions, invoices
...
for module in (auth, business, buyers, invoices, dashboard, decisions, audit_log):
